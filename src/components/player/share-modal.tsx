...
function SocialButton({ label, href, icon, className }: SocialButtonProps) {
  return (
    <a
      href={href}
      target="_blank"
...
export function ShareModal({
  ...
  const copyToClipboard = useCallback(
    async (text: string, which: "page" | "stream") => {
      try {
        await navigator.clipboard.writeText(text);
        if (which === "page") {
          setCopiedPage(true);
          setTimeout(() => setCopiedPage(false), COPY_RESET_MS);
        } else {
          setCopiedStream(true);
          setTimeout(() => setCopiedStream(false), COPY_RESET_MS);
        }
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                size="icon"
                variant="outline"
                onClick={() => void copyToClipboard(pageUrl, "page")}
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  size="icon"
                  variant="outline"
                  onClick={() => void copyToClipboard(streamUrl, "stream")}
